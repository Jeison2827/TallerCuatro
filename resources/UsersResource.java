package co.edu.unbosque.t4.resources;

import co.edu.unbosque.t4.dtos.ExceptionMessage;
import co.edu.unbosque.t4.dtos.User;
        ...
        try {
            ...
            if (user != null) {
                ...
                return Response.status(404)
                        .entity(new ExceptionMessage(404, "co.edu.unbosque.t4.dtos.User not found"))
                        .build();
            }
        } catch (IOException e) {
            return Response.serverError().build();
